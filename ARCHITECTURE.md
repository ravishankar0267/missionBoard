...
| Frontend Hosting | Appwrite Sites | Deployment & CDN |
| Frontend State | React Query + Context | Data management |
| Backend | .NET 8 + C# | Business logic |
| Backend Hosting | Appwrite Functions | Serverless compute |
| Database | Supabase PostgreSQL | Data persistence |
| Authentication | Appwrite Auth + Google OAuth | User identity |
...
- `/infrastructure/APPWRITE_CONFIG.md` - Appwrite setup
- `/infrastructure/SUPABASE_CONFIG.md` - Supabase setup
- `/infrastructure/DATABASE_SCHEMA.md` - Database schema
